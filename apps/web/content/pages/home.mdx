...
<Bridge>
  These are scenarios — drawn from the workflows we automate. [The free audit](#audit) shows you which ones are hiding in your business.
</Bridge>
...
<Steps>
  <Step title='Free systems audit.'>
    Tell us how your business runs — or let us take a look. You get back a map of your loops, the three places intelligence pays back fastest — ranked by the hours and cash they’d return — and a plan to build the first one. No
    call required.
  </Step>
